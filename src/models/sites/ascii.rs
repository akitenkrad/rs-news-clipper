...
const URL: &str = "https://ascii.jp/rss.xml";
...
impl WebSiteInterface for Ascii {
    ...
    async fn parse_article(&mut self, url: &str) -> AppResult<(Html, Text)> {
        ...
        let selector = scraper::Selector::parse("div#detail_contents").unwrap();
